      ...
      <div className="flex flex-col lg:flex-row gap-3 items-stretch lg:items-center">
        ...
        <div className="flex-1 min-w-0" onKeyDown={handleKeyPress}>
          <AddressAutocomplete
            ...
            className="h-12 text-base border-0 focus-visible:ring-2 focus-visible:ring-primary text-foreground bg-white"
          />
        </div>
        ...
        <Popover open={bedroomsOpen} onOpenChange={setBedroomsOpen}>
          <PopoverTrigger asChild>
            <Button 
              variant="outline" 
              className="h-12 px-4 min-w-[100px] justify-between bg-white hover:bg-muted/50 text-foreground border-input"
            >
