...
export default function Auth() {
  ...
  const handleGoogleSignIn = async (authRole: 'tenant' | 'landlord') => {
    setLoading(true);
    
    const { error } = await signInWithGoogle(authRole);
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    Continue with Google as Landlord
                  </Button>
                </div>
