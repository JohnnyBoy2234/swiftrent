...
const Slider = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root> & { variant?: 'default' | 'inverted' }
>(({ className, variant = 'default', ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track className={cn(
      ...
      variant === 'inverted' ? "bg-primary" : "bg-secondary"
    )}>
      <SliderPrimitive.Range className={cn(
        "absolute h-full",
        variant === 'inverted' ? "bg-secondary" : "bg-primary"
      )} />
    ...
    <SliderPrimitive.Thumb className={cn(
      ...
      variant === 'inverted' ? "border-secondary" : "border-primary"
    )} />
  </SliderPrimitive.Root>
))
